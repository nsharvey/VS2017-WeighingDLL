...
VSWizard.x64_.net2017_15.0 is a Visual Studio 15 wizard allowing you
...
configurations, for the Microsoft Visual Studio 15, 64 bits compiler.
...
1. Copy the files
       - RWViews.VSWizard.x64_.net2017_15.0.ico
       - RWViews.VSWizard.x64_.net2017_15.0.vsz
       - RWViews.VSWizard.x64_.net2017_15.0.vsdir
   to the directory
   <Program Files>\Microsoft Visual Studio\2017\<Edition>\Common7\IDE\VC\vcprojects.
2. Edit the copied RWViews.VSWizard.x64_.net2017_15.0.vsz file and set the
   value of the ABSOLUTE_PATH parameter to the absolute path for the
   VSWizard.x64_.net2017_15.0 directory. Typically, it will be
      C:\Program Files\Rogue Wave\Views M.m\tools\VSWizard.x64_.net2017_15.0
...
RWViews.VSWizard.x64_.net2017_15.0.vsz file.
