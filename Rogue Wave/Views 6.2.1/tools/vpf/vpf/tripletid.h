...
// File: tools/vpf/vpf/tripletid.h
// --------------------------------------------------------------------------
//
...
public:
    ...
    inline void		set(VpfInt ID, VpfInt tileID, VpfInt extID)
			{
			    _ID = ID;
			    _tileID = tileID;
			    _extID = extID;
			}
    inline VpfInt	getID() const { return _ID; }
    inline VpfInt	getTileID() const { return _tileID; }
    inline VpfInt	getExtID() const { return _extID; }
