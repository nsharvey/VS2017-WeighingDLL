...
public:
    ...
    inline VpfUInt	getNSegments() const { return _nSegments; }
    inline VpfSegment*	getSegment(VpfUInt i) const { return _segments[i]; }
...
// --------------------------------------------------------------------------
class VpfArea : public VpfFeatureItem
{
public:
    ...
    inline VpfUInt		getNRings() const { return _nRings; }
    inline VpfRing*		getRing(VpfUInt i) const { return _rings[i]; }
    inline void			setRing(VpfUInt i, VpfRing* ring)
				{
