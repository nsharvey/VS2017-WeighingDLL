...
public:
    VpfFeature(VpfFeatureClass*, const VpfExtent&,
	       VpfExtentMatchMode = VpfExModeContained);
    virtual ~VpfFeature();
    // ____________________________________________________________
    inline int		isBad() const { return (_class == 0); }
    inline void		setBad() { _class = 0; }

    int			select(const char* attribute = 0,
			       VpfValue*   value     = 0);
...
// --------------------------------------------------------------------------
class VpfLineFeature : public VpfFeature
{
public:
...
// --------------------------------------------------------------------------
class VpfPointFeature : public VpfFeature
{
public:
...
// ____________________________________________________________
class VpfTextFeature : public VpfFeature
{
public:
