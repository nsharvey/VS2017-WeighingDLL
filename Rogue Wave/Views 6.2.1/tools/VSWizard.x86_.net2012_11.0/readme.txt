        Rogue Wave Views wizard for Microsoft Visual Studio 11 README file


VSWizard.x86_.net2012_11.0 is a Visual Studio 11 wizard allowing you
...
configurations, for the Microsoft Visual Studio 11, 32 bits compiler.
...
1. Copy the files
       - RWViews.VSWizard.x86_.net2012_11.0.ico
       - RWViews.VSWizard.x86_.net2012_11.0.vsz
       - RWViews.VSWizard.x86_.net2012_11.0.vsdir
   to the directory <Program Files>\Microsoft Visual Studio 11.0\VC\vcprojects.
2. Edit the copied RWViews.VSWizard.x86_.net2012_11.0.vsz file and set the
   value of the ABSOLUTE_PATH parameter to the absolute path for the
   VSWizard.x86_.net2012_11.0 directory. Typically, it will be
      C:\Program Files\Rogue Wave\Views M.m\tools\VSWizard.x86_.net2012_11.0
...
RWViews.VSWizard.x86_.net2012_11.0.vsz file.
