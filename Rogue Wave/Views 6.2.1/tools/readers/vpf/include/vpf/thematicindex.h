...
// File: tools/readers/vpf/include/vpf/thematicindex.h
// --------------------------------------------------------------------------
//
...
public:
    ...
    VpfSet* getAssociatedFromIndex(VpfUInt i) const { return _sets[i]; }
...
// --------------------------------------------------------------------------
class VpfThematicInvertedIndex
: public VpfThematicIndex {
public:
    VpfThematicInvertedIndex(char elementType,
			     VpfUInt elementCount,
			     VpfUInt nElements, char IDType);
...
// --------------------------------------------------------------------------
class VpfThematicBitArrayIndex
: public VpfThematicIndex {
public:
