...
// File: tools/readers/vpf/include/vpf/segment.h
// --------------------------------------------------------------------------
//
...
public:
    ...
    VpfUInt getNCoordinates() const { return _nCoordinates; }
    VpfCoordinate* getCoordinate(VpfUInt) const;
    void setCoordinate(VpfUInt, const VpfCoordinate*);
    void setInverted(int inverted) { _inverted = inverted; }
    int isInverted() const { return _inverted; }
protected:
    VpfUInt		_ID;
    VpfUInt		_nCoordinates;
    VpfCoordinate*	_coordinates;
    int			_inverted;
    IlBoolean           _allocated;
};
