...
// File: include/ilviews/gadgets/motif/absbar.h
// --------------------------------------------------------------------------
//
...
//
// --------------------------------------------------------------------------
// Declaration of the IlvAbstractBarHandler classes
// Defined in library ilvgadgt
// --------------------------------------------------------------------------
#ifndef __Ilv_Gadgets_Motif_Absbar_H
#define __Ilv_Gadgets_Motif_Absbar_H
...
// --------------------------------------------------------------------------
class ILVMLOOKEXPORTED IlvAbstractBarMLFHandler
    : public IlvDefaultAbstractBarLFHandler
{
public:
    IlvAbstractBarMLFHandler(IlvLookFeelHandler*);
...
// --------------------------------------------------------------------------
ILVMLOOKMODULEINIT(mlfabsbr);

#endif /* !__Ilv_Gadgets_Motif_Absbar_H */
