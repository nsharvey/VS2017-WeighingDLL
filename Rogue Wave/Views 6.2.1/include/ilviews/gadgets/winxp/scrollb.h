...
// File: include/ilviews/gadgets/winxp/scrollb.h
// --------------------------------------------------------------------------
//
...
//
// --------------------------------------------------------------------------
// Declaration of the IlvScrollBarWXPLFHandler class
// Defined in library ilvwxplook
// --------------------------------------------------------------------------
#ifndef __Ilv_Gadgets_Winxp_ScrollBar_H
#define __Ilv_Gadgets_Winxp_ScrollBar_H
...
#if !defined(__Ilv_Gadgets_Win95_Scrollb_H)
...
// --------------------------------------------------------------------------
class ILVWXPLOOKEXPORTED IlvScrollBarWXPLFHandler
    : public IlvScrollBarW95LFHandler
{
public:
    IlvScrollBarWXPLFHandler(IlvLookFeelHandler* lfh);
    ~IlvScrollBarWXPLFHandler();
...
// --------------------------------------------------------------------------
ILVWXPLOOKMODULEINIT(wxpsb);

#endif /* _WIN32 */

#endif /* !__Ilv_Gadgets_Winxp_Scrollb_H */
