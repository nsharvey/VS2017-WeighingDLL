...
// File: include/ilviews/gadgets/windows/arrowb.h
// --------------------------------------------------------------------------
//
...
//
// --------------------------------------------------------------------------
// Declaration of the IlvArrowButtonWLFHandler class
// Defined in library ilvawlook
// --------------------------------------------------------------------------
#ifndef __Ilv_Gadgets_Windows_Arrowb_H
#define __Ilv_Gadgets_Windows_Arrowb_H
...
// --------------------------------------------------------------------------
class ILVADVWLOOKEXPORTED IlvArrowButtonWLFHandler
: public IlvArrowButtonLFHandler
{
public:
    IlvArrowButtonWLFHandler(IlvLookFeelHandler*);
...
// --------------------------------------------------------------------------
ILVADVWLOOKMODULEINIT(wlfarrb);

#endif /* !__Ilv_Gadgets_Windows_Arrowb_H */
