...
// File: include/ilviews/maps/geometry/geosegring.h
// --------------------------------------------------------------------------
//
...
#ifndef _Ilv_Maps_IlvSegmentRing_H
#define _Ilv_Maps_IlvSegmentRing_H

#include <ilviews/maps/geometry/georing.h>
#include <ilviews/maps/geometry/geosegstr.h>

ILVMAPSMODULEINIT(IlvMapSegmentRing);

class ILVMAPSEXPORTED IlvMapSegmentRing : public IlvMapRing
{
private:
    IlvMapSegmentString* _stroke;
...
private:
	IlvMapsIcFriend(IlvMapSegmentRing, ILVMAPSEXPORTED);
};
