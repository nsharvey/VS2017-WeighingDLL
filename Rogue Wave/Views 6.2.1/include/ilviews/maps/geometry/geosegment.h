...
// File: include/ilviews/maps/geometry/geosegment.h
// --------------------------------------------------------------------------
//
...
// Defines the interface for segment objects.
// --------------------------------------------------------------------------

#ifndef _Ilv_Maps_IlvMapSegment_H
#define _Ilv_Maps_IlvMapSegment_H

#include <ilviews/maps/geometry/geocurve.h>
#include <ilviews/base/clssinfo.h>

ILVMAPSMODULEINIT(IlvMapSegment);


class ILVMAPSEXPORTED IlvMapSegment : public IlvMapCurve
{
protected:
    IlvMapSegment();

public:
    virtual ~IlvMapSegment();
    ...
    virtual IlUInt getHorizontalIntersectionCount(
				  const IlvCoordinate& point) const = 0;

    virtual IlvMapGeometry* copy() const = 0;

    ILVMAPS_DECL_GEOM_MEMBERS();                           
private:
	IlvMapsIcFriend(IlvMapSegment, ILVMAPSEXPORTED);
};

#endif /* _Ilv_Maps_IlvMapSegment_H */
