...
// File: include/ilviews/edit/lispanel.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Edit_Lispanel_H
#define __Ilv_Edit_Lispanel_H
...
// --------------------------------------------------------------------------
class ILVEDTEXPORTED IlvListPanel
: public IlvInspectorPanel
{
public:
    IlvListPanel(IlvManager*, IlvSystemView transientFor = 0);
    // ____________________________________________________________
    virtual void applyChange(IlvGraphic*);
    virtual void initFrom(IlvGraphic*);
protected:
    IlvListPanel(IlvManager*,
