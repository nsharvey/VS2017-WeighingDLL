...
// File: include/ilviews/edit/mbpanel.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Edit_Mbpanel_H
#define __Ilv_Edit_Mbpanel_H
...
protected:
    IlvMenuBarPanel(IlvManager*,
		    ...
		    IlvSystemView transientFor = 0);
    void         setSelectedState(IlBoolean);
};

#endif /* !__Ilv_Edit_Mbpanel_H */
