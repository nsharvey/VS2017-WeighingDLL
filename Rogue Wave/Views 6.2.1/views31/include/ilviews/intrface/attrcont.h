...
// File: views31/include/ilviews/intrface/attrcont.h
// --------------------------------------------------------------------------
//
...
//
// --------------------------------------------------------------------------
// Declaration of the IlvAttributeContainerInterface class
// Defined in library ilvvar31
// --------------------------------------------------------------------------
#ifndef __Ilv31_Itf_Attrcont_H
#define __Ilv31_Itf_Attrcont_H
...
// --------------------------------------------------------------------------
#define IlvAttributeContainerInterface IlvACItf
class ILV31VAREXPORTED IlvGraphicAttribute;
class ILV31VAREXPORTED IlvAttributeContainerInterface
...
protected:
    virtual IlList* getAttributeList() const = 0;
};

#endif /* !__Ilv31_Itf_Attrcont_H */
