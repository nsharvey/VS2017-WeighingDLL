...
// File: samples/maps/projimg/src/gui.cpp
// --------------------------------------------------------------------------
//
...
// --------------------------------------------------------------------------
// Implementation of image projector GUI.
// --------------------------------------------------------------------------
#include <gui.h>
#include <centeri.h>
...
// --------------------------------------------------------------------------
static void
ShowMousePosition(IlvView* view, IlvEvent& event, IlvAny arg)
{
    Gui* viewer = (Gui*)arg;
...
// --------------------------------------------------------------------------
// Select : back to basic mode
// --------------------------------------------------------------------------
static void
Select(IlvGraphic* , IlvAny a)
{
    Gui* viewer = (Gui*)a;
    RemoveInteractor(viewer);
}
...
// --------------------------------------------------------------------------
static void
ComboItemSelected(IlvGraphic* g, IlvAny) {
...
Gui::~Gui()
{
    ...
    view->removeInputCallback(ShowMousePosition, this);
...
Gui::createGui(IlvDisplay* display)
{
    ...
    IlvView* view = _managerRectangle->getView();
    view->setInputCallback(ShowMousePosition, this);
...
Gui::createToolBar(IlvGadgetContainer* container)
{
    ...
    _comboBox->setCallback(ComboItemSelected);
