...
// File: samples/maps/projvect/include/pcenter.h
// --------------------------------------------------------------------------
//
...
// --------------------------------------------------------------------------
// Declaration of proj center interactor
// --------------------------------------------------------------------------
#ifndef _Pcenter_H
#define _Pcenter_H
...
{
public:
    ProjCenterInteractor(VectorProjector* ip);
...
private:
    VectorProjector* _vectorProjector;
    PointVector* _lat;
    PointVector* _long;
    IlvPalette* _palette;
    IlBoolean _started;
