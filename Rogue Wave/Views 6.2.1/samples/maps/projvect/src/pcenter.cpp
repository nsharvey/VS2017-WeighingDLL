...
// File: samples/maps/projvect/src/pcenter.cpp
// --------------------------------------------------------------------------
//
...
// --------------------------------------------------------------------------
// Implementation of proj center interactor.
// --------------------------------------------------------------------------
#include <pcenter.h>
...
// --------------------------------------------------------------------------
ProjCenterInteractor::ProjCenterInteractor(VectorProjector* ip)
...
{
    IlvCoordinate ll;
    IlvMapInfo* mapInfo = _vectorProjector->getMapInfo();
...
// --------------------------------------------------------------------------
void ProjCenterInteractor::doIt(IlvEvent& event)
{
    if (canCenter(event)) {
	_vectorProjector->centerProjection(getView(), event);
    }
}
...
ProjCenterInteractor::mouseMoved(IlvEvent& event)
{
    ...
    IlvManager* manager = _vectorProjector->getManager();
    IlvView* view = getView();
