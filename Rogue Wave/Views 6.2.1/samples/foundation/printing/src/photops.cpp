...
// File: samples/foundation/printing/src/photops.cpp
// --------------------------------------------------------------------------
//
...
static const char* LABEL = "Press to print on an A6 paper in landscape mode using Postscript without any dialog box";
static const char* title = "Printing sample: photops";
