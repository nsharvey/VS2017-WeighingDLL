...
// File: samples/foundation/bmpfilters/include/filtgraph.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Samples_Filtgraph_H
#define __Ilv_Samples_Filtgraph_H
...
// --------------------------------------------------------------------------
// Panel class for sample Filters
// --------------------------------------------------------------------------
class Filters : public PageNoteBook 
{
public:
    Filters(IlvAbstractView* view, const char* filename);
    ~Filters();
