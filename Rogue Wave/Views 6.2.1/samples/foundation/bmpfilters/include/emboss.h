...
// File: samples/foundation/bmpfilters/include/emboss.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Samples_Emboss_H
#define __Ilv_Samples_Emboss_H
...
// --------------------------------------------------------------------------
class Emboss : public PageNoteBook 
{
public:
    Emboss(IlvAbstractView* view, const char* filename);
    ~Emboss();
