...
// File: samples/dataccess/dbgraphe/src/app.cpp
// --------------------------------------------------------------------------
//
...
// --------------------------------------------------------------------------
extern void DefinePageGrapher(Pan*);
extern void DefinePageNodeGrapher(Pan*);
extern void DefinePageLinkGrapher(Pan*);
...
void
NoDbApp::makePanels() {
  Pan* panel = new Pan(getDisplay(), "Pan", "DbGraphe", IlvRect(0,0,500,500));
  addPanel(panel);
...
Pan::initializeSamples() {
  ...
  DefinePageGrapher(this);
  DefinePageNodeGrapher(this);
  DefinePageLinkGrapher(this);
  newPageSelected();
