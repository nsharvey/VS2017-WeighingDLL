...
// File: samples/dataccess/withdb/include/app.h
// --------------------------------------------------------------------------
//
...
// Application class
// --------------------------------------------------------------------------
class DbApp: public IlvApplication 
{
public:
  DbApp(const char* app,const char* display=0,int argc=0,char** argv=0);
  DbApp(IlvDisplay*,const char*,IlvBoolean owner = IlvFalse);
  ~DbApp();
