...
// File: samples/gadgets/table/src/app.cpp
// --------------------------------------------------------------------------
//
...
// --------------------------------------------------------------------------
extern void DefinePageEdit(Pan*);
extern void DefinePageHuge(Pan*);
extern void DefinePageMatrix(Pan*);
extern void DefinePageRandom(Pan*);
...
Pan::initializeSamples()
{
    ...
    DefinePageEdit(this);
    DefinePageHuge(this);
    DefinePageMatrix(this);
    DefinePageRandom(this);
    newPageSelected();
}
