...
// File: samples/gadgets/dockable/include/dockapp.h
// --------------------------------------------------------------------------
//
...
protected:
    ...
    void                     loadMainWindowInfo(ILVSTDPREF istream& i);
    void                     loadDockingConfiguration(ILVSTDPREF istream& i);
    void                     writeMainWindowInfo(ILVSTDPREF ostream& o);
    void                     writeDockingConfiguration(ILVSTDPREF ostream& o);
};
...
public:
    ...
    virtual IlvDockableMainWindow*
                             createMainWindow(const IlvRect& rect) const;
    void                     initPanes();
    IlUInt                   getPanesCount() const {return _panes.getLength();}
