...
// File: samples/charts/scrolling/include/shiftcar.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Samples_Shiftcar_H
#define __Ilv_Samples_Shiftcar_H
...
// --------------------------------------------------------------------------
class Shiftcar : public PageNoteBook
{
public:
    Shiftcar(IlvAbstractView* view, const char* filename);
    ~Shiftcar();
...
#endif /* !__Ilv_Samples_Shiftcar_H*/
