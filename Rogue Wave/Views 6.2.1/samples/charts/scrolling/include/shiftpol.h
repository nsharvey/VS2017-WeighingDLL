...
// File: samples/charts/scrolling/include/shiftpol.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Samples_Shiftpol_H
#define __Ilv_Samples_Shiftpol_H
...
// --------------------------------------------------------------------------
class Shiftpol : public PageNoteBook
{
public:
    Shiftpol(IlvAbstractView* view, const char* filename);
    ~Shiftpol();
...
#endif /* !__Ilv_Samples_Shiftpol_H*/
