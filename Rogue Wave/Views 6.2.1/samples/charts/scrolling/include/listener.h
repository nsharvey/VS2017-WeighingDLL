...
// File: samples/charts/scrolling/include/listener.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Samples_Listener_H
#define __Ilv_Samples_Listener_H
...
// --------------------------------------------------------------------------
class Listener : public PageNoteBook
{
public:
    Listener(IlvAbstractView* view, const char* filename);
    ~Listener();
...
#endif /* !__Ilv_Samples_Listener_H*/
