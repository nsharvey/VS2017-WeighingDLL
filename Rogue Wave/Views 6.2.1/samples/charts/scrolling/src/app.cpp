...
// File: samples/charts/scrolling/src/app.cpp
// --------------------------------------------------------------------------
//
...
// --------------------------------------------------------------------------
extern void DefinePageCyclic(Pan*);
extern void DefinePageShiftpol(Pan*);
extern void DefinePageShiftcar(Pan*);
extern void DefinePageListener(Pan*);
...
Pan::initializeSamples()
{
	...
	DefinePageCyclic(this);
	DefinePageShiftpol(this);
	DefinePageShiftcar(this);
	DefinePageListener(this);
	newPageSelected();
    }
}
