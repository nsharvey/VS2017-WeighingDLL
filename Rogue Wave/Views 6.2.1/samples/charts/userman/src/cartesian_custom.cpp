...
// File: samples/charts/userman/src/cartesian_custom.cpp
// --------------------------------------------------------------------------
//
...
main(int argc, char* argv[])
{
    ...
    // Set the name of the days as labels for the abscissa scale.
    const char* labels[7] = {
	"Monday",
	"Tuesday",
	"Wednesday",
    ...
    IlUInt labelsCount = 7;
    abscissaScale->setStepLabels(labelsCount, labels);

    // Add a label at the end of the ordinate scale axis.
    ordinateScale->setAxisLabel("Celsius");

    // Add an arrow at the end of the scales axis.
