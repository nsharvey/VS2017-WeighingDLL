...
// File: samples/charts/interactors/include/lens.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Samples_Lens_H
#define __Ilv_Samples_Lens_H
...
// --------------------------------------------------------------------------
class Lens : public PageNoteBook
{
public:
    Lens(IlvAbstractView* view, const char* filename);
    ~Lens();
