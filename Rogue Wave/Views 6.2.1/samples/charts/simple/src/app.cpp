...
// File: samples/charts/simple/src/app.cpp
// --------------------------------------------------------------------------
//
...
// --------------------------------------------------------------------------
extern void DefinePageCartesian(Pan*);
extern void DefinePagePolar(Pan*);
extern void DefinePageXml(Pan*);
extern void DefinePageXmlDate(Pan*);
...
Pan::initializeSamples()
{
	...
	DefinePageCartesian(this);
	DefinePagePolar(this);
	DefinePageXml(this);
	DefinePageXmlDate(this);
	newPageSelected();
    }
}
