...
// File: samples/charts/scales/src/scales.cpp
// --------------------------------------------------------------------------
//
...
{
    IlvSetLocale();
    IlvDisplay* display = new IlvDisplay("ScalesApp", "", argc, argv);
    if (display->isBad()) {
    ...
    localPath.addDirectory("samples/charts/scales/data");
    display->prependToPath(localPath);

    const char* title = "Rogue Wave Views sample: chart scales";
