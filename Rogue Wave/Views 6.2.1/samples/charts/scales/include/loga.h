...
// File: samples/charts/scales/include/loga.h
// --------------------------------------------------------------------------
//
...
#ifndef __Ilv_Samples_Loga_H
#define __Ilv_Samples_Loga_H
...
// --------------------------------------------------------------------------
class Logarithmic : public PageNoteBook
{
public:
    Logarithmic(IlvAbstractView* view, const char* filename);
    ~Logarithmic();

protected:
    void initLogarithmic();
};

#endif /* !__Ilv_Samples_Loga_H*/
