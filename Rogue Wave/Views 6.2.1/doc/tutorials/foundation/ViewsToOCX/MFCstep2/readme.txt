========================================================================
		ActiveX Control DLL : DEMOMFC
========================================================================

ControlWizard has created this project for your DEMOMFC ActiveX Control
...
that make up your DEMOMFC ActiveX Control DLL.
...
DemoMFCCtl.h
	This file contains the declaration of the CDemoMFCCtrl C++ class.

DemoMFCCtl.cpp
	This file contains the implementation of the CDemoMFCCtrl C++ class.

DemoMFCPpg.h
	This file contains the declaration of the CDemoMFCPropPage C++ class.

DemoMFCPpg.cpp
	This file contains the implementation of the CDemoMFCPropPage C++ class.

DemoMFCCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CDemoMFCCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file DemoMFC.rc.
