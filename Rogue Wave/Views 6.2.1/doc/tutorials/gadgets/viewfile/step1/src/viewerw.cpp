...
// File: doc/tutorials/gadgets/viewfile/step1/src/viewerw.cpp
// --------------------------------------------------------------------------
//
...
{
    // Create the tree gadget in which the directory hierarchy will
    // be displayed
    IlvTreeGadget* tree =
    ...
    IlvGraphicPane* treePane = new IlvGraphicPane("DirectoryHierarchy",
						  tree);
    // The tree is resizable, that is, it will be possible to interactively
    // resize it using a splitter.
