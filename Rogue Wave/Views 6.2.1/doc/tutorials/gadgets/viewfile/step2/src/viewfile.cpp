...
// File: doc/tutorials/gadgets/viewfile/step2/src/viewfile.cpp
// --------------------------------------------------------------------------
//
...
: IlvApplication(name, displayName, argc, argv)
{
    ...
    // To locate data
    getDisplay()->prependToPath("doc/tutorials/gadgets/viewfile/data");
}
...
FileViewerApplication::~FileViewerApplication()
{
    ...
    delete FileViewerApplication::GetFileViewer(getMainWindow());
}
