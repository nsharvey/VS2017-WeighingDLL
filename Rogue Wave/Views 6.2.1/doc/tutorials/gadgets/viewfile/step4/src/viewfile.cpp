...
// File: doc/tutorials/gadgets/viewfile/step4/src/viewfile.cpp
// --------------------------------------------------------------------------
//
...
FileViewerApplication::~FileViewerApplication()
{
    ...
    for (IlvUInt i = 0; i < getDesktopManager()->getCardinal(); i++) {
...
// ------------------------------------------------------------------------
static void
DestroyFrame(IlvView* view, IlvAny)
{
    delete view;
}
