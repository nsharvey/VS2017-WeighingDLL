...
//RW Customization -- Changed Browser.SamHierarchy to add RefMan
        ...
        for (index = param_document.links.length - 1; index >= 0; index -= 1) {
            ...
            if (Browser.ContainsClass(link.className, 'ww_behavior_email')) {
                ...
                link.href = mailto;
                 ...
                 (Browser.SameHierarchy(Page.connect_info.base_url, link.href))
                  &&
                 (!Browser.SameHierarchy(Page.connect_info.base_url + 'RefMan/', link.href))
                ) {
