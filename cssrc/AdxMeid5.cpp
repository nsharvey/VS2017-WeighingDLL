...
/******************************************************
*                                                     *
*    PILOTE DE PERIPHERIQUE METTLER ID5 MULTIRANGE    *
*                                                     *
*******************************************************
*                                                     *
*  REALISATION CONCEPTUELLE : MC                      *
*              MATERIELLE   : METTLER ID5 MULTIRANGE  *
*              LOGICIELLE   : MC                      *
*                                                     *
*-----------------------------------------------------*
*                                                     *
...
*************************************************/
void AdxMeid5::weighingTreatment(AdxWeighingInterface* wi,
...
* appel du multi com                             *
*************************************************/
void AdxMeid5::callMultiCom(int pornum, ComOperation comOp, char* iodata)
{
	DriverStatus sta;
	int nbcMax = 256;
...
*************************************************/
void AdxMeid5::emissionMsg(void)
{
	char trailer[3] = {"\r\n"};
	...
	if (getWeighingInterface()->getInterface()->getTraceMode() == 1)
    {
		getWeighingInterface()->getInterface()->_traceFile << "\t"<< "Send to scaleID5" << endl;
...
*************************************************/
void AdxMeid5::receptionMsg(void)
{
	// gbe 11/08
    ...
    if (getWeighingInterface()->getInterface()->getTraceMode() == 1)
    {
		getWeighingInterface()->getInterface()->_traceFile << "\t"<< "Receive from scaleID5" << endl;
...
*************************************************/
void AdxMeid5::transaction(void)
{
	emissionMsg();
...
*************************************************/
void AdxMeid5::decodeResponse(void)
{
...
* Transcodage unité                              *
*************************************************/
void AdxMeid5::transcodeUnite(char* unit)
{
...
* Contrôle unité                                 *
*************************************************/
bool AdxMeid5::controleUnite(char* unit)
{
	if (strcmp(unit,"kg") == 0
		|| strcmp(unit,"g") == 0
		|| strcmp(unit,"lb") == 0
...
*************************************************/
void AdxMeid5::delay(int milliSec)
{
	clock_t start, end;
	start = clock();
	do
